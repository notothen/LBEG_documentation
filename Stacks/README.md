...
## Preparing the working directory and the data ![#F8CBAD](https://via.placeholder.com/15/F8CBAD/000000?text=+)
...
## Demultiplexing and filtering (trimming) the reads ![#B4C7E7](https://via.placeholder.com/15/B4C7E7/000000?text=+)
...
## Working on a subset of samples for parameter testing ![#C5E0B4](https://via.placeholder.com/15/C5E0B4/000000?text=+)
...
## Running Stacks on the full dataset ![#D39AFE](https://via.placeholder.com/15/D39AFE/000000?text=+)
...
## Filtering genotypes and exporting the data ![#FFE699](https://via.placeholder.com/15/FFE699/000000?text=+)
