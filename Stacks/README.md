...
# *De novo* analysis
<p align="center">
<img src="https://github.com/Enorya/LBEG_documentation/blob/main/Stacks/Denovo_pipeline.jpg" alt="denovo_pipeline" width="500"/>
</p>

## Preparing the working directory and the data ![#F8CBAD](https://via.placeholder.com/20/F8CBAD/000000?text=+)
...
## Demultiplexing and filtering (trimming) the reads ![#B4C7E7](https://via.placeholder.com/20/B4C7E7/000000?text=+)
...
## Working on a subset of samples for parameter testing ![#C5E0B4](https://via.placeholder.com/20/C5E0B4/000000?text=+)
...
## Running Stacks on the full dataset ![#D39AFE](https://via.placeholder.com/20/D39AFE/000000?text=+)
...
## Filtering genotypes and exporting the data ![#FFE699](https://via.placeholder.com/20/FFE699/000000?text=+)
...
<p align="center">
<img src="https://github.com/Enorya/LBEG_documentation/blob/main/Stacks/Reference-based_pipeline.jpg" alt="reference-based_pipeline" width="300"/>
</p>

## Preparing, demultiplexing and filtering the data ![#B4C7E7](https://via.placeholder.com/20/B4C7E7/000000?text=+)
